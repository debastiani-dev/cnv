...
class Purchase(BaseModel):
    ...
    type = models.CharField(
        _("Type"), max_length=20, choices=TYPE_CHOICES, default=TYPE_PURCHASE
    )
...
class PurchaseItem(BaseModel):
    ...
    def save(self, *args, **kwargs):
        ...
        # TODO: Trigger signal to update Purchase total # pylint: disable=fixme

    def __str__(self):
        return f"{self.quantity}x {self.content_object} in {self.purchase}"
