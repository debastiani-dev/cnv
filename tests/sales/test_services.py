...
class TestSaleService:
    def test_update_sale_totals(self):
        ...
        # Item 1: 1 * 100 = 100
        SaleItem.objects.create(sale=sale, content_object=cow1, quantity=1, unit_price=Money("100.00"))
        # Item 2: 2 * 50 = 100
        SaleItem.objects.create(sale=sale, content_object=cow2, quantity=2, unit_price=Money("50.00"))
